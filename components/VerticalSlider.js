...
export default class Slider extends PureComponent {
  ...
  render() {
    ...
    delete other.minimumValue;
    delete other.maximumValue;
    delete other.minimumTrackTintColor;
    delete other.maximumTrackTintColor;
    delete other.thumbTintColor;
    delete other.thumbImage;
    delete other.styles;
    delete other.style;
    delete other.trackStyle;
    delete other.thumbStyle;
    delete other.debugTouchArea;
  ...
  _getPropsForComponentUpdate(props) {
    ...
    delete otherProps.onSlidingStart
    delete otherProps.onSlidingComplete
    delete otherProps.style
    delete otherProps.trackStyle
    delete otherProps.thumbStyle
    return otherProps;
  }
